      ...
      if (null !== t) {
        if ((a++, 1 === t.nodeType)) {
          ...
          if (e.indexOf(r) >= 0) {
            ...
            "" === n[o] ? (i.insertBefore(p(), t), s.push(t)) : (t.data = n[o]),
              (d += o);
          }
        } else if (8 === t.nodeType)
          if (t.data === r) {
            const e = t.parentNode;
            (null !== t.previousSibling && a !== o) ||
    ...
    for (; r < i.length; )
      if (((o = i[r]), c(o))) {
        for (; a < o.index; )
          a++,
            "TEMPLATE" === l.nodeName &&
              (e.push(l), (n.currentNode = l.content)),
            null === (l = n.nextNode()) &&
              ((n.currentNode = e.pop()), (l = n.nextNode()));
        if ("node" === o.type) {
  ...
  getHTML() {
    ...
    for (let i = 0; i < t; i++) {
      ...
      e +=
        null === o
          ? t + (s ? m : a)
          : t.substr(0, o.index) + o[1] + o[2] + "$lit$" + o[3] + r;
    }
...
class v {
  ...
  _getValue() {
    ...
    for (let i = 0; i < e; i++) {
      ...
      if (void 0 !== e) {
        const t = e.value;
        if (_(t) || !y(t)) s += "string" == typeof t ? t : String(t);
...
const N = (t) =>
  t &&
  (C ? { capture: t.capture, passive: t.passive, once: t.once } : t.capture);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 */ const E = new (class {
  handleAttributeExpressions(t, e, s, i) {
    ...
    return "@" === n
      ? [new T(t, e.slice(1), i.eventContext)]
      : "?" === n
      ? [new b(t, e.slice(1), s)]
      : new v(t, e, s).parts;
  }
 ...
 */ function A(t) {
  ...
  return (
    (s = e.keyString.get(i)),
    void 0 === s &&
      ((s = new d(t, t.getTemplateElement())), e.keyString.set(i, s)),
 ...
 */ function U(t, e) {
  ...
  for (; n.nextNode(); ) {
    ...
    for (
      ...
      (r.index = null !== h ? -1 : r.index - l), (o = M(i, o)), (r = i[o]);
  }
...
const j = (t) => (e) => {
    ...
    if (((n = i.keyString.get(o)), void 0 === n)) {
      ...
      $ && window.ShadyCSS.prepareTemplateDom(s, t),
        (n = new d(e, s)),
        i.keyString.set(o, n);
    }
      ...
      ? (function (t, e, s = null) {
          ...
          for (; o.nextNode(); ) {
            for (
              l++,
                o.currentNode === s &&
                  ((a = R(e)), s.parentNode.insertBefore(e, s));
              -1 !== r && n[r].index === l;
    ...
    if (
      (((t, e, s) => {
        ...
        void 0 === n &&
          ...
          n.setValue(t),
          n.commit();
      })(t, l, Object.assign({ templateFactory: j(n) }, s)),
      a)
    ) {
      const t = V.get(l);
      V.delete(l);
...
let st = class extends tt {
  constructor() {
    super(...arguments),
      (this.swpath =
        window.location.pathname.replace(/\/$/, "") + "/" + "pwabuilder-sw.js"),
  ...
  async firstUpdated() {
    if (this.swpath && "serviceWorker" in navigator) {
      ...
      if (t.installing && navigator.storage) {
        ...
        if (t) {
          (this.storageUsed = this.formatBytes(t.usage)),
  ...
  render() {
    return O`<div>${
      this.readyToAsk
        ? O`<div id=updateToast part=updateToast><span>${
            this.updatemessage
          }</span> <button @click=${() =>
      ...
      this.showOfflineToast
        ? O`<div id=storageToast part=offlineToast>Ready to use Offline ${
            this.showStorageEstimate
              ? O`<span id=storageEstimate>Cached ${this.storageUsed}</span>`
              : null
          }</div>`
        : null
    }</div>`;
